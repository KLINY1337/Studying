import graphviz
import os
'''url1='https://github.com/KLINY1337/Airport-model-on-Java/commit/09ee35bbda3a1b22c4c413ffb63163fe4f6fc0d0'
url2='https://github.com/KLINY1337/TESTrepo/commit/bdfae6c3af01025d2bba15900e79e43eeb9f9a51'
r=requests.get(url2)
...
def main():
    ...
    for filename in os.listdir(path_commits):
        ...
        if os.path.isfile(f):
            ...
            f=f.replace("\\",'/')
            createGraph(dot, f)
    dot.render("C:/Users/KLINY-ПК/Desktop/.data/Учёба/3 семестр/Конфиг/DZ5/test.gv", view=True)
